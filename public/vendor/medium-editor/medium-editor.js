        ...
        getButtonLabels: function (buttonLabelType) {
            ...
            if (buttonLabelType === 'fontawesome') {
                customButtonLabels = {
                    ...
                    'quote': '<i class="<b>&ldquo;</b>"></i>',
                    'orderedlist': '<b>1.</b>',
                    'unorderedlist': '<span class="glyphicon glyphicon-list"></span>',
                    'pre': '<b>0101</b>',
                    'indent': '<i class="glyphicon glyphicon-indent-left"></i>',
                    'outdent': '<i class="glyphicon glyphicon-indent-right"></i>'
                };
